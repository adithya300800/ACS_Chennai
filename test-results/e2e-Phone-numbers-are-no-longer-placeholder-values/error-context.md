...
- Name: e2e.test.js >> Phone numbers are no longer placeholder values
- Location: e2e.test.js:52:5
...
Call log:
  - waiting for locator('.contact-card-value').first()
...
- generic [active] [ref=e1]:
  ...
  - link "/ACS_Chennai/contact" [ref=e2] [cursor=pointer]:
    - /url: /ACS_Chennai/contact
  - text: instead?
```
