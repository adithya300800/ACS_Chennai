...
- Name: e2e.test.js >> Careers page loads at /careers route
- Location: e2e.test.js:17:5
...
Locator: locator('h2').filter({ hasText: 'Join the ACS Chennai Team' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2').filter({ hasText: 'Join the ACS Chennai Team' })
