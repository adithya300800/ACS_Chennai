...
- Name: e2e.test.js >> Blog article loads at /blog/:slug
- Location: e2e.test.js:23:5
...
Locator: locator('h1').filter({ hasText: /Construction Schedule/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: /Construction Schedule/ })
...
- generic [active] [ref=e1]:
  ...
  - link "/ACS_Chennai/blog/construction-schedule-failing" [ref=e2] [cursor=pointer]:
    - /url: /ACS_Chennai/blog/construction-schedule-failing
  - text: instead?
```
