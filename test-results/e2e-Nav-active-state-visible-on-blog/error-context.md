...
- Name: e2e.test.js >> Nav active state visible on /blog
- Location: e2e.test.js:10:5
...
Locator: locator('nav a').filter({ hasText: 'Blog' })
...
Call log:
  ...
  - waiting for locator('nav a').filter({ hasText: 'Blog' })
...
- generic [active] [ref=e1]:
  ...
  - link "/ACS_Chennai/blog" [ref=e2] [cursor=pointer]:
    - /url: /ACS_Chennai/blog
  - text: instead?
```
